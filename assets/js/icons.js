/* ==========================================================
   CodeCave — line icon set (Feather-style, MIT-licensed shapes)
   Swaps [data-icon] elements for inline SVG at runtime.
   ========================================================== */
(function () {
  "use strict";
  var I = {
    ...
    "link-2":'<path d="M18 13v6a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/>',
    ...
    "graduation-cap":'<path d="M22 10L12 4 2 10l10 6 10-6z"/><path d="M6 12v5c0 1.66 2.69 3 6 3s6-1.34 6-3v-5"/>',
  ...
  function swap(){
    document.querySelectorAll("[data-icon]").forEach(function (el) {
      ...
      var s = svg(key);
      if (!s) return;
      if (el.classList.contains("icon") || el.classList.contains("emoji") || el.classList.contains("pd-visual") || el.classList.contains("thumb")) {
        el.innerHTML = s;
      } else {
        el.innerHTML = '<span class="icon">' + s + "</span>" + (el.dataset.iconLabel ? " " + el.dataset.iconLabel : "");
      }
      el.dataset.iconDone = "1";
    });
  }
  window.CC_ICONS = { svg: svg, swap: swap };
